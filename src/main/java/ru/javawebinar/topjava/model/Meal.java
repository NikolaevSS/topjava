...
@Entity
@Table(name = "meals",
        uniqueConstraints = {@UniqueConstraint(name = "user_meals_idx", columnNames = {"user_id", "date_time"})}
)
public class Meal extends AbstractBaseEntity {
    public static final String GET = "Meal.get";
    public static final String DELETE = "Meal.delete";
    public static final String GET_ALL_SORTED = "Meal.getAll";
    public static final String GET_BETWEEN_HALF_OPEN_SORTED = "Meal.getBetweenHalfOpen";
