...
@NamedEntityGraphs({
        @NamedEntityGraph(name = User.MEALS_GRAPH,
                attributeNodes = {@NamedAttributeNode("roles"), @NamedAttributeNode("meals")}
        )
})
@Entity
...
public class User extends AbstractNamedEntity {
    ...
    public static final String MEALS_GRAPH = "User.meals";
